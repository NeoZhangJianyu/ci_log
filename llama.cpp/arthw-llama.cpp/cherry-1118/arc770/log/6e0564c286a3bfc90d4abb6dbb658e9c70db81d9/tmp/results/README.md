...
26/28 Test #26: test-backend-ops ..................***Failed   20.72 sec
...
Backend 2/2 (SYCL0)
  ...
  MUL_MAT(type_a=q4_1,type_b=f32,m=16,n=1,k=32,bs=[1,1],nr=[1,1]): [MUL_MAT] NMSE = 1.003139045 > 0.000500000 [1;31mFAIL[0m
  MUL_MAT(type_a=q4_1,type_b=f32,m=16,n=1,k=256,bs=[1,1],nr=[1,1]): [1;32mOK[0m
  MUL_MAT(type_a=q5_0,type_b=f32,m=16,n=1,k=32,bs=[1,1],nr=[1,1]): [MUL_MAT] NMSE = 0.322831711 > 0.000500000 [1;31mFAIL[0m
  MUL_MAT(type_a=q5_0,type_b=f32,m=16,n=1,k=256,bs=[1,1],nr=[1,1]): [1;32mOK[0m
  MUL_MAT(type_a=q5_1,type_b=f32,m=16,n=1,k=32,bs=[1,1],nr=[1,1]): [MUL_MAT] NMSE = 0.644417415 > 0.000500000 [1;31mFAIL[0m
  MUL_MAT(type_a=q5_1,type_b=f32,m=16,n=1,k=256,bs=[1,1],nr=[1,1]): [1;32mOK[0m
  MUL_MAT(type_a=q8_0,type_b=f32,m=16,n=1,k=32,bs=[1,1],nr=[1,1]): [MUL_MAT] NMSE = 0.713648383 > 0.000500000 [1;31mFAIL[0m
...
28/28 Test #30: test-json-schema-to-grammar .......Subprocess aborted***Exception:   1.55 sec
